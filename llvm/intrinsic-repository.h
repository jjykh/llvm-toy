...
#define FOR_EACH_FTL_INTRINSIC(macro) \
    ...
    macro(gcResult, "llvm.experimental.gc.result", functionType(ref8, tokenType)) \
    macro(gcRelocate, "llvm.experimental.gc.relocate", functionType(ref8, tokenType, int32, int32)) \
