...
#define FOR_EACH_FTL_INTRINSIC(macro) \
    ...
    macro(statepoint, "llvm.experimental.gc.statepoint.p0f_isVoidf", functionType(tokenType, int64, int32, pointerType(functionType(voidType)), int32, int32, Variadic)) \
