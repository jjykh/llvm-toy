...
#define FOR_EACH_FTL_INTRINSIC(macro) \
    ...
    macro(statepoint, "llvm.experimental.gc.statepoint", functionType(tokenType, int64, int32, ref8, int32, int32, Variadic)) \
    macro(gcResult, "llvm.experimental.gc.result", functionType(taggedType, tokenType)) \
    macro(gcRelocate, "llvm.experimental.gc.relocate", functionType(taggedType, tokenType, int32, int32)) \
